...
const Features = () => {
    const iconStyle = `w-max pr-2 text-[1.5rem] sm:text-[1.5rem] `;
  return (
    <>
        <div className='font-poppins p-8 bg-[#cfe9ff]'>
            ...
            <div id='text-section' className='flex justify-center items-center pb-8'>
                <ul className='md:w-[50em] text-gray-600 text-base px-4 md:px-6 lg:px-[3em] md:text-md lg:text-lg'>
                    <li className='flex items-start'><TiTick className={iconStyle}/> Early access to webinars and workshops led by industry experts.</li>
                    <li className='flex items-start pt-3'><TiTick className={iconStyle}/> Curated content to keep you updated on the latest trends and breakthroughs.</li>
                    <li className='flex items-start py-3'><TiTick className={iconStyle}/>Networking events to connect with fellow enthusiasts and potential collaborators.</li>
